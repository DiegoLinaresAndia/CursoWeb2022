...
function CalcularSueldoFinal(){
    ...
    tbD=document.getElementById("rbD");
    ...
    }else if(rbA.cheked==false && rbB.checked==false && rbC.checked==false && rbD.checked==false){
        alert("Seleccion una categoria");
        rbA.focus();
    }else{
